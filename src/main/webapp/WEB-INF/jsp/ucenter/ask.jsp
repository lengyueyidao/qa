...
<body style="padding: 25px;zoom: 0;" >
    <form id="myform">
        ...
        <input type="text" id="title" name="title" style="width: 50%;height: 30px"/>
        <label for="content">内容</label>
        <div id="test-editormd" style="z-index: 2;">
            <textarea name="content" id="content" ></textarea>
        </div>
        <label for="tags">标签</label>
        <input type="text" id="tags" name="tags" style="width: 50%;height: 30px" placeholder="每个标签之间用;隔开"/>
        <div>
